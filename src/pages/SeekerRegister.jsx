    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Join as a Seeker</h1>
          <p className="text-gray-600">Begin your journey towards spiritual fulfillment</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <div className="flex items-center justify-center space-x-2 text-gray-500">
            ...
            <span className="text-sm">Join thousands on their spiritual journey</span>
          </div>
        </div>
      </div>
    </div>
