          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full pl-9 pr-3 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white text-sm"
                    placeholder="Phone"
                  />
                </div>
              </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-3">
                ...
                />
                <label className="text-sm text-gray-600 leading-relaxed">
                  Send me updates about new campaigns and impact stories
                </label>
              </div>
            </div>
